...
**Repository state:** branch `main` · in sync with `origin/main` at `5b47372` (repair rate-limit mitigation; two UI passes `5773140`/`960f931` shipped in the same push). No-push policy in `AGENTS.md`.
